...
<html class="no-js" lang="en">
  <head>
    ...
    <title>Shopping Cart || Manci </title>
    ...
    <div class="row" style="margin-top:10px;">
      <div class="large-12">
        <?php
          ...
          if(isset($_SESSION['username'])) {
            echo '<a href="orders-update.php"><button style="float:right;">Buy Now</button></a>';
          }
    ...
    <div class="row" style="margin-top:10px;">
      <div class="small-12">
        ...
        <footer style="margin-top:10px;">
           <p style="text-align:center; font-size:0.8em;clear:both;">&copy; S&R. All Rights Reserved.</p>
        </footer>
